...
def app():
    ...
    st.write('<p style="font-size:20px;">This model has been designed to suggest possible zipcodes for inhabitance based on the criteria you provide.</p>', unsafe_allow_html=True)
