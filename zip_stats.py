...
def app():
    ...
    def zip_data(zipcode):
        ...
        zipdata['pop_density'] = [scs.percentileofscore(all_data["pop_density"].values, i) for i in zipdata["pop_density"]]
        zipdata['pop_density'] =zipdata['pop_density']/100
        zipcode = str(zipcode)
    ...
    z = st.text_input('Type in a Zipcode!')
